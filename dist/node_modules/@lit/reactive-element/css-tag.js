 ...
 */
const r = window, c = r.ShadowRoot && (r.ShadyCSS === void 0 || r.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, a = Symbol(), i = /* @__PURE__ */ new WeakMap();
class l {
  constructor(s, t, o) {
...
const h = (e) => new l(typeof e == "string" ? e : e + "", void 0, a), d = (e, ...s) => {
  ...
  c ? e.adoptedStyleSheets = s.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet) : s.forEach((t) => {
