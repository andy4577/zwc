...
import { queryAll as f } from "../../../../../node_modules/@lit/reactive-element/decorators/query-all.js";
...
import { unsafeHTML as x } from "../../../../../node_modules/lit-html/directives/unsafe-html.js";
...
var y = Object.defineProperty, $ = Object.getOwnPropertyDescriptor, i = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? $(t, r) : t, d = e.length - 1, l; d >= 0; d--)
    (l = e[d]) && (s = (o ? l(t, r, s) : l(s)) || s);
  return o && s && y(t, r, s), s;
};
let a = class extends v {
  ...
  render() {
    ...
    return n`
      <div class="${u(e)}" ?data-scroll-to-tab=${this.scrollToTab}>
        <nav>
